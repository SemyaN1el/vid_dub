"""Объективные метрики качества дубляжа: Speaker Verification (resemblyzer), WER/CER через обратный ASR (jiwer) и семантическая близость LaBSE."""
...
def plot_labse(
    ...
    if output_path:
        ...
        logger.info("LaBSE-график сохранён: %s", output_path)
    plt.close(fig)

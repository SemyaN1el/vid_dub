...
def run_project_doctor(
    *,
    ...
    if include_dependency_checks:
        ...
        _add_module_checks(
            checks,
            modules=("torch", "whisper", "transformers", "TTS"),
            prefix="Python ML",
        )
        _add_module_checks(
            checks,
        ...
        needs_openai = (
            getattr(config, "ASR_PROVIDER", "") == "groq"
            or getattr(config, "METRICS_ASR_PROVIDER", "") == "groq"
            or (
